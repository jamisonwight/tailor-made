					...
					av_showmodal = function() {
						...
						var content_agegate = $(
							`
								...
								<p>You must be 21 years of age or older to enter this site. By clicking yes you affirm that you are at least 21 years old.</p>
								<p>You can learn more about how we use cookies by reviewing our <a data-fancybox data-type="iframe" data-src="/privacy-policy.html" href="javascript:;" aria-disabled="true">Privacy Policy</a>.</p>
								<small style="margin-top: 20px">&copy; <?php echo Date("Y"); ?> Tailor Made Wines, Ripon, CA</small>
							`
						);
						var regret_content = $(
							` 
