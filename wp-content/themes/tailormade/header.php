					...
					av_showmodal = function() {
						...
						var content_agegate = $(
							`
								...
								<div class="agree"><label for="agree" class="show-for-sr">I agree to the Terms of Service and Privacy Policy</label><input type="checkbox" id="agree" class="btn-default" required name="agree" role="tab" aria-selected="true" tabindex="1"><div>I agree to the <a data-fancybox data-type="iframe" data-src="/terms-of-service.html" href="javascript:;" aria-disabled="true">Terms of Service</a> and <a data-fancybox data-type="iframe" data-src="/privacy-policy.html" href="javascript:;" aria-disabled="true">Privacy Policy</a></div></div>
								...
								<p style="color: #ffffff; max-width: 400px; font-size: 16px !important;">You must be 21 years of age or older to enter this site. By clicking yes you affirm that you are at least 21 years old.<br> You can learn more about how we use cookies by reviewing our <a style="color: #ffffff !important;" data-fancybox data-type="iframe" data-src="/privacy-policy.html" href="javascript:;" aria-disabled="true">Privacy Policy</a>.</p>
								<small style="color: #ffffff; margin-top: 20px;">&copy; <?php echo Date("Y"); ?> Tailor Made Wines, Ripon, CA</small>
							`
						);
						var regret_content = $(
							` 
